...
public class OccupancySensor extends TimedSensor implements HazardSensor,
    ...
    public int getHazardLevel() {
        ...
        double occupancyPercentage = 100 * occupancyRatio;
     ...
     * of 14 people would have a comfort level of 30. A sensor with a capacity
     * of 15 people and a current reading of 17 people would have a comfort
     * level of 0.
     *
     * Floating point division should be used when performing the calculation,
    ...
    public int getComfortLevel() {
        if (getCurrentReading() > getCapacity()) {
            ...
            float comfortLevel = (float) (((getCapacity() -
                    getCurrentReading()) * 100) / getCapacity());
    ...
    public boolean equals(Object obj) {
        if (super.equals(obj)) {
            OccupancySensor occupancySensor = (OccupancySensor) obj;
            return this.getCapacity() == occupancySensor.getCapacity();
        } else {
            return false;
        }
    }
     ...
     * Two occupancy sensors that are equal according to equals(Object) should
     ...
     * The format of the string to return is:
     *
     *  OccupancySensor:sensorReading1,sensorReading2,...,sensorReadingN:
     *  frequency:capacity
     *
     ...
     * is this sensor's update frequency (in minutes), and 'capacity' is the
     * maximum capacity of the room monitored by this sensor.
    ...
    public String encode() {
        return String.format(
                "OccupancySensor:%s:%d:%d", super.encode(),
                this.getUpdateFrequency(), this.capacity);
    }
}
