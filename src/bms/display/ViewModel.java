...
public class ViewModel {
    ...
    public void save(String filename) throws IOException {
        ...
        for (int i = 0; i < getBuildings().size() - 1; i++) {
            writer.write(getBuildings().get(i).encode());
            writer.write(System.lineSeparator());
        }
        writer.write(getBuildings().get(getBuildings().size() - 1).encode());
        writer.close();
    }
